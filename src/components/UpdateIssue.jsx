...
{  /*  <h3 className="font-bold text-lg">Update your issue </h3>  */}
    ...
    <div className='text-gray-900'> 
        <form onSubmit={handleUpdate} className="border p-4 rounded-lg text-base-content">
        <h1 className='p-2 text-2xl font-semibold text-center'>Update Your Issue</h1>

   {/* Issue Title */}
    <div className="mb-5">
    <label className="block mb-2 text-sm font-medium text-base-content text-start">Title</label>
  ...
  {/* Category */}
   <div className="mb-5">
          <label className="block mb-2 text-sm font-medium text-base-content text-start">Category</label>
   ...
   {/* Description */}
  <div className="mb-5">
    <label  className="block mb-2 text-sm font-medium text-base-content text-start">Description</label>
    ...
    <div className="mb-5 items-start">
          <label className="block mb-2 text-sm font-medium text-base-content text-start">Status</label>
          <select name='status' className='flex justify-start items-start bg-gray-50 border border-gray-300 text-gray-900 rounded'>
